...
public class LauncherActivity extends BaseActivity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.e("xxx6", getResources().getString(getResources().getIdentifier("app_name", "string", "com.example.plugindemo")));
		Log.e("xxx7", getResources().getString(getResources().getIdentifier("app_name", "string", getPackageName())));
		Log.e("xxx8", getResources().getString(HostProxy.getShareStringId("app_name")));
	...
	private static void startFragmentInHostActivity(Context context, String targetId) {
		...
		pluginActivity.setClassName(context, "com.tencent.tws.pluginhost.TestFragmentActivity");
