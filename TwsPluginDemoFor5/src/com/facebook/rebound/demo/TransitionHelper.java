...
public class TransitionHelper {
  ...
  public static void startIntroAnim(View root, AnimatorListenerAdapter introEndListener) {
    ...
    introAnimate((DepthLayout) root.findViewById(R.id.fab_container), MOVE_Y_STEP * 2f, 20f, 45,
        190);
    introAnimate((DepthLayout) root.findViewById(R.id.dl2), MOVE_Y_STEP, 20f, 60, 200);
    introAnimate((DepthLayout) root.findViewById(R.id.dl3), MOVE_Y_STEP * 2, 20f, 75,
        210).addListener(introEndListener);
  }

  static ObjectAnimator introAnimate(final DepthLayout target, final float moveY,
      final float customElevation, long delay, int subtractDelay) {
    ...
    ObjectAnimator translationY =
        ObjectAnimator.ofFloat(target, View.TRANSLATION_Y, 0).setDuration(700);
    translationY.setInterpolator(new BackOut());
    translationY.setStartDelay(700 + 800);
    translationY.start();

    ObjectAnimator rotationX =
        ObjectAnimator.ofFloat(target, View.ROTATION_X, TARGET_ROTATION_X, 0).setDuration(1000);
    ...
    ObjectAnimator elevation = ObjectAnimator.ofFloat(target, "CustomShadowElevation",
        customElevation * target.getResources().getDisplayMetrics().density,
        target.getCustomShadowElevation()).setDuration(1000);
    elevation.setInterpolator(new QuintInOut());
    elevation.setStartDelay(700 + FISRTDELAY + subtractDelay * 2);
    elevation.start();
    target.setCustomShadowElevation(
        customElevation * target.getResources().getDisplayMetrics().density);

    ObjectAnimator scaleX =
        ObjectAnimator.ofFloat(target, View.SCALE_X, TARGET_SCALE, target.getScaleX())
            .setDuration(1000);
    ...
    ObjectAnimator scaleY =
        ObjectAnimator.ofFloat(target, View.SCALE_Y, TARGET_SCALE, target.getScaleY())
            .setDuration(1000);
    ...
    ObjectAnimator rotation =
        ObjectAnimator.ofFloat(target, View.ROTATION, TARGET_ROTATION, 0).setDuration(1400);
  ...
  public static void startExitAnim(View root) {
    ...
    exitAnimate((DepthLayout) root.findViewById(R.id.fab_container), MOVE_Y_STEP * 2f, 20f, 45, 210,
        true);
  ...
  static ValueAnimator exitAnimate(final DepthLayout target, final float moveY,
      final float customElevation, long delay, int subtractDelay, boolean continueOffscreen) {
    ...
    ObjectAnimator rotationX =
        ObjectAnimator.ofFloat(target, View.ROTATION_X, TARGET_ROTATION_X).setDuration(DURATION);
    rotationX.setInterpolator(VALUEinterpolator);
    rotationX.setStartDelay(delay);
    rotationX.start();

    ObjectAnimator elevation =
        ObjectAnimator.ofFloat(target, "CustomShadowElevation", target.getCustomShadowElevation(),
            customElevation * target.getResources().getDisplayMetrics().density)
    ...
    ObjectAnimator scaleX =
        ObjectAnimator.ofFloat(target, View.SCALE_X, TARGET_SCALE).setDuration(DURATION);
    scaleX.setInterpolator(new QuintOut());
    scaleX.setStartDelay(delay);
    scaleX.start();

    ObjectAnimator scaleY =
        ObjectAnimator.ofFloat(target, View.SCALE_Y, TARGET_SCALE).setDuration(DURATION);
    scaleY.setInterpolator(new QuintOut());
    scaleY.setStartDelay(delay);
    scaleY.start();

    ObjectAnimator rotation =
        ObjectAnimator.ofFloat(target, View.ROTATION, TARGET_ROTATION).setDuration(1600);
  ...
  private static void continueOutToRight(DepthLayout target, float moveY, int subtractDelay) {
    ...
    ObjectAnimator translationX2 =
        ObjectAnimator.ofFloat(target, View.TRANSLATION_X, target.getTranslationX(),
  ...
  public static void animateToMenuState(View root, AnimatorListenerAdapter onMenuAnimFinished) {
    ...
    exitAnimate((DepthLayout) root.findViewById(R.id.dl3), MOVE_Y_STEP * 2, 20f, 75, 250,
        false).addListener(onMenuAnimFinished);
  ...
  public static void startRevertFromMenu(View root,
    ...
    revertFromMenu((DepthLayout) root.findViewById(R.id.dl3), 20f, 40, 2).addListener(
        animatorListenerAdapter);
    ObjectAnimator translationY =
        ObjectAnimator.ofFloat(root, View.TRANSLATION_Y, 0).setDuration(DURATION);
    translationY.setInterpolator(new QuintInOut());
    translationY.start();
  }

  static ObjectAnimator revertFromMenu(final DepthLayout target, final float customElevation,
      int subtractDelay, float targetElevation) {
    ...
    ObjectAnimator rotationX =
        ObjectAnimator.ofFloat(target, View.ROTATION_X, target.getRotationX(), 0).setDuration(1000);
    rotationX.setInterpolator(new QuintInOut());
    ...
    ObjectAnimator elevation =
        ObjectAnimator.ofFloat(target, "CustomShadowElevation", target.getCustomShadowElevation(),
            targetElevation * target.getResources().getDisplayMetrics().density).setDuration(1000);
    elevation.setInterpolator(new QuintInOut());
    ...
    ObjectAnimator scaleX =
        ObjectAnimator.ofFloat(target, View.SCALE_X, target.getScaleX(), 1f).setDuration(1000);
    scaleX.setInterpolator(new CircInOut());
    ...
    ObjectAnimator scaleY =
        ObjectAnimator.ofFloat(target, View.SCALE_Y, target.getScaleY(), 1f).setDuration(1000);
    scaleY.setInterpolator(new CircInOut());
    ...
    ObjectAnimator rotation =
        ObjectAnimator.ofFloat(target, View.ROTATION, target.getRotation(), 0).setDuration(1100);
